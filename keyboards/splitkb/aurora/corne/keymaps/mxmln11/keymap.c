...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, KC_VOLU,   KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_PGUP, XXXXXXX,
        KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS, KC_VOLD,    XXXXXXX, KC_END, KC_HOME, XXXXXXX, KC_PGDN, XXXXXXX,
	...
	[3] = LAYOUT_split_3x6_3(
        QK_BOOT, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, RGB_M_K, RGB_M_T,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_M_X, RGB_M_TW,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
